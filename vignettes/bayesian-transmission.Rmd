...
The model is run through the `runMCMC()` function. This function takes
...
To create trace plots and posterior distributions, we need to convert this nested
list structure into a tidy data frame format.
