...
class MVNormalRandom: public Random
{
private:
	...
	static void mult(int p, double **x, double **y, double **a)
	{
		for (int i=0; i<p; i++)
			for (int j=0; j<p; j++)
			{
	...
	static void multrans(int p, double **x, double **y, double **a)
	{
		for (int i=0; i<p; i++)
			for (int j=0; j<p; j++)
			{
...
public:
	MVNormalRandom(int seed) : Random(seed)
	{
	}
