...
void init_Module_infect(){
    ...
    class_<infect::HistoryLink>("CppHistoryLink")
        ...
        .property("hasPatientPrev", &HistoryLink::hasPatientPrev)
        .property("hasPatientNext", &HistoryLink::hasPatientNext)
        .property("hasHistoryPrev", &HistoryLink::hasHistoryPrev)
        .property("hasHistoryNext", &HistoryLink::hasHistoryNext)
        .property("hasUnitPrev", &infect::HistoryLink::hasUnitPrev)
        .property("hasUnitNext", &HistoryLink::hasUnitNext)
        .property("hasFacilityPrev", &HistoryLink::hasFacilityPrev)
        .property("hasFacilityNext", &HistoryLink::hasFacilityNext)
        .property("SystemPrev", &HistoryLink::hasSystemPrev)
        .property("SystemNext", &HistoryLink::hasSystemNext)
